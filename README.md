# MINEXX - Système de Gestion de Véhicules

## Description

MINEXX est une application Django complète pour la gestion de flotte de véhicules, incluant :
...
1. **Connecter le repository GitHub**
   ...
   - Sélectionnez le repository `ASOFES/minexx`
...
- `minexx-mobile-app/` : Application principale
- `minexx_test_web/` : Application de test
...
1. **Cloner le repository**
   ```bash
   git clone https://github.com/ASOFES/minexx.git
   cd minexx
   ```
...
**MINEXX** - Système de gestion de flotte professionnel 