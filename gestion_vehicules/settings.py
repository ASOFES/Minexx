...
# Configuration CORS pour l'API mobile (origines explicites uniquement)
# cors_config.py définit déjà CORS_ALLOWED_ORIGINS / CORS_ALLOW_CREDENTIALS
_extra_cors = os.environ.get('CORS_ALLOWED_ORIGINS', '')
if _extra_cors:
    CORS_ALLOWED_ORIGINS = list(set(
        list(CORS_ALLOWED_ORIGINS) + [o.strip() for o in _extra_cors.split(',') if o.strip()]
    ))
